...
# https://github.com/3timeslazy/nix-search-tv/blob/main/nixpkgs.sh og link, changed for it to open zsh
...
NIX_SHELL_CMD='nix-shell --impure --run zsh -p $(echo "{}" | sed "s:nixpkgs/::g"'
